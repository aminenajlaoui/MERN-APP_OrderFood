          ...
          <tbody>
            ...
            {cartData.products.map((product) => (
              <tr className={styles.tr}>
                ...
                <td>
                  <span className={styles.price}>DT{product.price}</span>
                </td>
                <td>
                ...
                <td>
                  <span className={styles.total}>
                    DT{product.price * product.quantity}
                  </span>
                </td>
              </tr>
            ))}
      ...
      <div className={styles.right}>
        <div className={styles.wrapper}>
          ...
          <div className={styles.totalText}>
            <b className={styles.totalTextTitle}>Subtotal:</b>DT{cartData.total}
          </div>
          <div className={styles.totalText}>
            <b className={styles.totalTextTitle}>Discount:</b>DT0.00
          </div>
          <div className={styles.totalText}>
            <b className={styles.totalTextTitle}>Total:</b>DT{cartData.total}
          </div>
